import {decodeHTML, decodeXML, DecodingMode} from '/_snowpack/pkg/entities.lib.decode.v4.5.0.js';
export {DecodingMode, EntityDecoder, decodeHTML, decodeHTML as decodeHTML4, decodeHTMLStrict as decodeHTML4Strict, decodeHTML as decodeHTML5, decodeHTMLStrict as decodeHTML5Strict, decodeHTMLAttribute, decodeHTMLStrict, decodeXML, decodeXML as decodeXMLStrict} from '/_snowpack/pkg/entities.lib.decode.v4.5.0.js';
import {xmlReplacer, getCodePoint, escapeUTF8, escapeAttribute, escapeText, encodeXML} from '/_snowpack/pkg/entities.lib.escape.v4.5.0.js';
export {encodeXML, escape, escapeAttribute, escapeText, escapeUTF8} from '/_snowpack/pkg/entities.lib.escape.v4.5.0.js';
...
restoreDiff([[9, "&Tab;"], [0, "&NewLine;"], [22, "&excl;"], [0, "&quot;"], [0, "&num;"], [0, "&dollar;"], [0, "&percnt;"], [0, "&amp;"], [0, "&apos;"], [0, "&lpar;"], [0, "&rpar;"], [0, "&ast;"], [0, "&plus;"], [0, "&comma;"], [1, "&period;"], [0, "&sol;"], [10, "&colon;"], [0, "&semi;"], [0, {
    v: "&lt;",
    n: 8402,
    o: "&nvlt;"
}], [0, {
    ...
    v: "&ll;",
    n: new Map(/* #__PURE__ */
    restoreDiff([[824, "&nLtv;"], [7577, "&nLt;"]]))
}], [0, {
    v: "&gg;",
    n: new Map(/* #__PURE__ */
    restoreDiff([[824, "&nGtv;"], [7577, "&nGt;"]]))
...
export {EncodingMode, EntityLevel, decode, decodeStrict, encode, encodeHTML, encodeHTML as encodeHTML4, encodeHTML as encodeHTML5, encodeNonAsciiHTML};
