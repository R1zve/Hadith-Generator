import {decodeHTML, decodeXML, DecodingMode} from '../pkg/entities.lib.decode.v4.5.0.js';
export {DecodingMode, EntityDecoder, decodeHTML, decodeHTML as decodeHTML4, decodeHTMLStrict as decodeHTML4Strict, decodeHTML as decodeHTML5, decodeHTMLStrict as decodeHTML5Strict, decodeHTMLAttribute, decodeHTMLStrict, decodeXML, decodeXML as decodeXMLStrict} from '../pkg/entities.lib.decode.v4.5.0.js';
import {xmlReplacer, getCodePoint, escapeUTF8, escapeAttribute, escapeText, encodeXML} from '../pkg/entities.lib.escape.v4.5.0.js';
export {encodeXML, escape, escapeAttribute, escapeText, escapeUTF8} from '../pkg/entities.lib.escape.v4.5.0.js';
